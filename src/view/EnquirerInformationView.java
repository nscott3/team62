...
public class EnquirerInformationView extends JDialog {

    private JButton btnBack = new JButton("Go Back");

    public EnquirerInformationView(PropertyInfo propertyinfo, String startDate, String endDate) {
        setResizable(false);
        ...
        btnBack.addActionListener(e -> {
            new EnquirerSpecificView(propertyinfo, startDate, endDate).setVisible(true);
            this.dispose();
        });
    }
}
