...
public class EnquirerSpecificView extends JFrame {
    ...
    public EnquirerSpecificView(PropertyInfo propertyinfo, String startDate, String endDate) {
        setResizable(false);
        ...
        btnBooking.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Please register as guest to book.", "Error!", JOptionPane.DEFAULT_OPTION);
        ...
        btnInfo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                new EnquirerInformationView(propertyinfo, startDate, endDate).setVisible(true);
                dispose();
            }
        });
        ...
        btnBack.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (formatted) {
                    new EnquirerSearchView(propertyinfo.getLocation(), tfStartDay.getText(), tfEndDay.getText());
                    setVisible(false);
                } else {
